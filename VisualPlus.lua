	...
	function win:AddTab(tabOpts)
		...
		tabBtn.MouseButton1Click:Connect(function()
			if win.ActiveTab and win.ActiveTab ~= tab then
				...
				tw(win.ActiveTab.Button, 0.15, {BackgroundTransparency = 1, TextColor3 = Theme.TextDim})
				tw(win.ActiveTab.Indicator, 0.15, {BackgroundTransparency = 1})
			end
			win.ActiveTab = tab
			tab.Page.Visible = true
			tw(tabBtn, 0.15, {BackgroundTransparency = 0, BackgroundColor3 = Theme.Panel, TextColor3 = Theme.Text})
